    ...
    render () {
        return (
            <div>
                ...
                <CounterControl label="Add 5" clicked={this.props.addCounter.bind(this,5)}  />
                <CounterControl label="Subtract 5" clicked={this.props.subtractCounter.bind(this,5)}  />
            </div>
        );
    }
}
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        subtractCounter: (value) => dispatch({type:"SUB", value:value})
    }
}
